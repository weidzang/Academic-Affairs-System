...
//        ServiceAdmin service = new ServiceAdminImpl();
        PageBean<Teacher> pb = service.cs_findTeacherByPage(currentPage,rows,condition);
...
//        System.out.println(pb.toString());
        ...
        //4.转发到list.jsp
        request.getRequestDispatcher("admin/teacherInfoList.jsp").forward(request,response);
    }
