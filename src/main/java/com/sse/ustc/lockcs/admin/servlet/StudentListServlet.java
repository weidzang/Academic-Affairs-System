...
//        ServiceAdmin service = new ServiceAdminImpl();
        PageBean<Student> pb = service.cs_findStudentByPage(currentPage,rows,condition);
...
//        System.out.println(pb.toString());
        ...
        //4.转发到list.jsp
        request.getRequestDispatcher("admin/changeStuListInfo.jsp").forward(request,response);
    }
