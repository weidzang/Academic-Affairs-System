    ...
    <div style="float:left;width: 85%;">
        ...
        <div class="container">
            <div style="float: left;margin-top: 20px">
                <form class="form-inline" action="${pageContext.request.contextPath}/studentListServlet"
                      method="post">
                    <div class="form-group">
                        <label for="studentId">学号</label>
                        <input type="text" name="studentId" value="${condition.studentId[0]}" class="form-control"
                               id="studentId">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="data" name="level" value="${condition.level[0]}" class="form-control"
                               id="level">
                    </div>
                    ...
                    <tr align="center">
                        ...
                        <th>
                            <input type="submit" value="修改"
                                   onclick="window.location.href = '${pageContext.request.contextPath}/returnOneStuServlet?studentId=${t.studentId}'"
                                   style="border:1px solid rgb(154, 240, 154);">
                                <%--<input type="button" value="删除" onclick="window.location.href = 'javascript:deleteUser(${t.studentId},${pb.currentPage});'" style="border:1px solid rgb(248, 69, 69);">--%>
                        </th>
                    </tr>
                </c:forEach>
            </table>
        ...
        <div style="margin-left: 15%;margin-bottom: 10%">
            <nav aria-label="Page navigation">
                <ul class="pagination pagination-lg">
                    <li>
                        <a href="${pageContext.request.contextPath}/studentListServlet?currentPage=${pb.currentPage -1}&rows=10&studentId=${condition.studentId[0]}&name=${condition.name[0]}&level=${condition.level[0]}"
                           aria-label="Previous">
                        ...
                        <c:if test="${pb.currentPage == i}">
                            <li class="active">
                                <a style="color: #0f0f0f;"
                                   href="${pageContext.request.contextPath}/studentListServlet?currentPage=${i}&rows=10&studentId=${condition.studentId[0]}&name=${condition.name[0]}&level=${condition.level[0]}">&nbsp;&nbsp;${i}&nbsp;</a>
                            </li>
                        </c:if>
                        <c:if test="${pb.currentPage != i}">
                            <li>
                                <a href="${pageContext.request.contextPath}/studentListServlet?currentPage=${i}&rows=10&studentId=${condition.studentId[0]}&name=${condition.name[0]}&level=${condition.level[0]}">&nbsp;&nbsp;${i}&nbsp;</a>
                            </li>
                        </c:if>
                    </c:forEach>
